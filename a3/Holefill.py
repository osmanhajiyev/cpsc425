...
def CopyPatch(imHole,TODOMask,textureIm,iPatchCenter,jPatchCenter,iMatchCenter,jMatchCenter,patchL):
	...
	for i in range(patchSize):
		for j in range(patchSize):
			...
			# if statement to make sure we fill only the "hole" pixels and not other useful ones
			if(TODOMask[i][j] == 1):
				# fill holed image with the required calculated pixel
...
im = Image.open('/Users/osman/School/CPSC425/cpsc425/a3/floral.jpg').convert('RGB')
...
Image.fromarray(imHole).convert('RGB').save('/Users/osman/School/CPSC425/cpsc425/a3/resultsBrick.jpg')
